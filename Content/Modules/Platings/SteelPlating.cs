...
{
	public class SteelPlating : BaseModule
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Increases heat transfer rate to 11 W/m2\nProvides 2.2 kJ of heat capacity");
			HeatCapacity = 2500;

			ModuleData.Defense.Set(Type, 6);
