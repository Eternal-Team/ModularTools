...
internal class ModularHook : ModProjectile
{
	...
	public override void Load() => chainTexture = ModContent.Request<Texture2D>(ModularTools.TexturePath + "Projectiles/ModularHook_Chain");
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		while (distance > 30f && !float.IsNaN(distance))
		{
			...
			Main.spriteBatch.Draw(chainTexture.Value, center - Main.screenPosition, null, lightColor, projRotation, chainTexture.Size() * 0.5f, 1f, SpriteEffects.None, 0f);
		}
